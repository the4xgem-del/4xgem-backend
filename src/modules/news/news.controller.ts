...
export const newsController = {
  async list(req: Request, res: Response) {
    const result = await newsService.list(req.query as unknown as ListNewsQuery);
  ...
  async create(req: AuthenticatedRequest, res: Response) {
    const article = await newsService.create(req.user!.id, req.body as CreateNewsInput);
